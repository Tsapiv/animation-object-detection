...
if __name__ == '__main__':
    config = parse_config()
    vae = MODELS[config['model_type']].load_from_checkpoint(checkpoint_path=config['checkpoint_path'],
                                                            map_location='cpu')
    vae.eval()
    ...
    print("Clustering:", clustering_accuracy(vae.encoder, loader, 'cpu', nth=1))
